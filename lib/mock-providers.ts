...
export const mockOpenAI = {
  ...
  hardLimitUsd: 100,
  softLimitUsd: 80,
  monthlySpendUsd: 78.40,
  accessUntil: null,
  error: null,
  _summary: "pay-as-you-go · $78.40/mo",
  _signal: "At 78% of hard limit — approaching cutoff.",
  _status: "warn",
  _providerSummary: {
    serviceId: "openai",
    serviceName: "OpenAI",
    ...
    groups: [
      {
        ...
        label: "Billing",
        items: [
          { key: "Monthly Spend", value: "$78.40", alert: "warn" },
          { key: "Hard Limit", value: "$100.00" },
          { key: "Quota Used", value: "78%", alert: "warn" },
      ...
      },
      {
        ...
        label: "Usage",
        items: [
          { key: "gpt-4o Cost", value: "$62.00" },
          { key: "gpt-4o-mini Cost", value: "$16.40" },
          { key: "Total Tokens", value: "2.1M" },
        ],
      },
    ],
  },
...
export const mockTwilio = {
  ...
  _signal: "Trial account — cannot send to unverified numbers.",
  _status: "warn",
  _providerSummary: {
    serviceId: "twilio",
    serviceName: "Twilio",
    ...
    groups: [
      {
        ...
        items: [
          ...
          { key: "Account Type", value: "Trial", alert: "warn" },
      ...
      },
      {
        ...
        label: "Warnings",
        items: [
          { key: "Trial Restriction", value: "Can only send to verified numbers", alert: "warn" },
        ],
      },
    ],
  },
